...
const ContactForm: React.FC<ContactFormProps> = ({ domain }) => {
  ...
  const FormLabel = ({ htmlFor, label }: { htmlFor: string; label: string }) => (
    <label htmlFor={htmlFor} className="block text-[#444444] dark:text-[#dcc397] font-semibold mb-2">
  ...
  return form.valid === true ? (
    ...
    <form action={formAction} className="max-w-lg mx-auto p-6 bg-white dark:bg-[#2b2c2a] rounded-lg">
      <h2 className="text-2xl font-bold text-[#444444] dark:text-[#dcc397] text-center">Make an Offer</h2>
      ...
      <div className="hidden">
        <label htmlFor="domain" className="block text-[#444444] dark:text-[#dcc397] font-semibold mb-2">
          Domain
        </label>
        <input
          type="text"
      ...
      <div className="hidden">
        <label htmlFor="honeypot" className="block text-[#444444] dark:text-[#dcc397] font-semibold mb-2">
